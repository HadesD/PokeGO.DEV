  ...
  @section('indexMaster.body')
    ...
    <div id="pokemon-list" class="">
      ...
      <ul id="sort_pokemon" class="dropdown-content">
        ...
        <li><a href="#!" class="sort" data-sort="newEst">Date Time</a></li>
      </ul>
      <div class="row list">
        @foreach($pokemonData as $key => $value)
          ...
          <div class="col s12 m6 l3">
            ...
            <li>
              <div class="collapsible-header"><i class="material-icons">whatshot</i>More</div>
              <div class="collapsible-body">
                <div class="card-header">
                  <span class="newEst">{{ $value->getCreationTimeMs() }}</span>
                </div>
  ...
  var options = {
    valueNames: [ 'pokemonCp', 'pokemonIvsperfect', 'pokemonHeightM', 'pokemonWeightKg', 'pokemonId', 'newEst' ]
  };
